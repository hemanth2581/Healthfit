...
import { DayDietPlan, WeeklyPlan } from '@/types/nutrition';
...
export const localStore = {
  ...
  // Daily Progress
  getTodayProgress(userId: string, targetWaterMl: number = 2800): DailyProgress {
  ...
  saveTodayProgress(progress: DailyProgress): void {
    ...
    try {
      ...
      // Calculate completion percentage: 7 items (5 meals, 1 workout, 1 water/sleep target)
      let score = 0;
